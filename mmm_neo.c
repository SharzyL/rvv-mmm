...
// X, Y and M are arrays of of uint16_t padded into uint32_t of length n,
// representing a big integer, with MSB first (big endian),
// big endian is necessary because during propagation we need to extract MSB
// R = r^n X, Y < M < R
